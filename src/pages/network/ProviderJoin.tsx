...
export default function ProviderJoin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error } = await supabase.from('provider_applications').insert({
      ...
      lien_experience: form.lien_experience,
      hipaa_baa_agreed: form.hipaa_baa_agreed,
    });
    ...
    return (
      <PublicLayout>
        <div className="max-w-lg mx-auto px-6 py-20 text-center space-y-4">
          ...
          <h2 className="text-2xl font-display font-bold">Application Received</h2>
          <p className="text-muted-foreground">Thank you. Our network team will review your application and contact you within 2 business days.</p>
        </div>
      </PublicLayout>
    );
  }
    ...
    <PublicLayout>
      <div className="max-w-2xl mx-auto px-6 py-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-display font-bold text-foreground">Join the Provider Network</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-start gap-2">
            ...
            <Label htmlFor="baa" className="text-sm">I agree to execute a HIPAA Business Associate Agreement with GHIN *</Label>
          </div>
