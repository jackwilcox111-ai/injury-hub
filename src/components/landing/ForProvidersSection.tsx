...
export function ForProvidersSection() {
  ...
  return (
    <section id="providers" className="py-14 relative overflow-hidden">
      <div className="absolute -top-20 -right-40 w-[500px] h-[500px] rounded-full bg-success/[0.03] blur-3xl" />

      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <span className="text-xs font-medium uppercase tracking-widest text-success mb-2 block">For Providers</span>
            <h2 className="text-3xl font-display font-bold text-foreground mb-5">Grow Your Practice with PI Patients</h2>
            ...
            <Button className="mt-6 gap-2 rounded-lg" onClick={() => navigate('/provider/join')}>
