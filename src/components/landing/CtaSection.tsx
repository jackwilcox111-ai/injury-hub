  ...
  return (
    <section className="relative py-14 overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
        ...
        <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground mb-3">Ready to Get Started?</h2>
        <p className="text-muted-foreground mb-7 text-base max-w-md mx-auto leading-relaxed">
