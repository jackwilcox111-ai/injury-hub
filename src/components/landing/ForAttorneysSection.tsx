...
export function ForAttorneysSection() {
  ...
  return (
    <section id="attorneys" className="py-14 bg-card border-y border-border/60 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="order-1 md:order-2">
            <span className="text-xs font-medium uppercase tracking-widest text-primary mb-2 block">For Attorneys</span>
            <h2 className="text-3xl font-display font-bold text-foreground mb-5">The Care Coordination Partner Your Clients Need</h2>
            ...
            <Button className="mt-6 gap-2 rounded-lg" onClick={() => navigate('/attorney/join')}>
