    ...
    return (
      <PublicLayout>
        <div className="max-w-lg mx-auto px-6 py-20 text-center space-y-4">
          ...
          <h2 className="text-2xl font-display font-bold">Partnership Application Received</h2>
          <p className="text-muted-foreground">Thank you. A GHIN partnership coordinator will be in touch within 1 business day.</p>
        </div>
      </PublicLayout>
    );
  }
    ...
    <PublicLayout>
      <div className="max-w-2xl mx-auto px-6 py-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-display font-bold text-foreground">Partner with GHIN</h2>
